...
const variants = {
    ...
    'accent': "bg-accent-700 <hover:bg-accent-5></hover:bg-accent-5>00 active:bg-accent-900 text-primary-50 transition duration-150 md:heading-6 text-base rounded-lg px-5 py-3 flex justify-center items-center",
};
