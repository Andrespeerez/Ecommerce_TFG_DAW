...
export default function ProductCard({ product = productFake }) {
    ...
    return (
        ...
        className="rounded-[20px] flex flex-col justify-between gap-3 pb-[10px] bg-neutral-300 lg:w-[30%] max-w-[450px] w-[75%] overflow-hidden border-t-1 lg:h-[600px] md:h-[500px]"
        >
