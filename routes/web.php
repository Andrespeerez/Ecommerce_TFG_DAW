...
// Static pages:
Route::get('/cocinas-a-medida', function() {
    return Inertia::render('Errors/Construction');
});

Route::get('/armarios-empotrados', function() {
    return Inertia::render('Errors/Construction');
});
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::patch('/area-cliente/shipment', [ProfileController::class, 'updateShipment'])->middleware('throttle:4,1')->name('profile.update.shipment');
